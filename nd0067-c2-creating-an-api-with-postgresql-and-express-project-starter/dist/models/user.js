...
var UserStore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        return [4 /*yield*/, conn.query('SELECT id, first_name, last_name FROM users')];
                    case 2:
                        result = _a.sent();
                        conn.release();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        return [4 /*yield*/, conn.query('SELECT id, first_name, last_name FROM users WHERE id=($1)', [id])];
                    case 2:
                        result = _a.sent();
                        conn.release();
    ...
    UserStore.prototype.authenticate = function (first_name, password) {
        return __awaiter(this, void 0, void 0, function () {
